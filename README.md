...
| `src/data/recipes.ts` | الوصفات المجانية — انسخ أي كتلة وعدّلها لإضافة وصفة |
...
| `/recipes` | فهرس الوصفات المجانية مع بحث بالاسم والمكوّنات وتصنيفات |
| `/recipes/:slug` | الوصفة كاملة ببيانات `Recipe` المنظّمة لجوجل |
